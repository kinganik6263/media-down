...
## Example (install)
```js
const alif = require('alif-media-downloader');
...
## Instagram Usage 
```js
const {instagram} = require("alif-media-downloader");
...
## Example (TikTok)
```js
const { tikdown } = require("alif-media-downloader")
...
## Example (YouTube)
```js
const { ytdown } = require("alif-media-downloader")
let URL = await ytdown("https://youtu.be/aRSuyrZFu_Q?si=bsfzgeeGmRpsHqnF")
console.log(URL)
```
## Example (Twitter)
```js
const { twitterdown } = require("alif-media-downloader")
...
## Example Fbdown 
```js
const { fbdown } = require("alif-media-downloader");
...
## Example Fbdown2
```js
const { fbdown2 } = require("alif-media-downloader");
const request = require('request')
...
## Usage GDLink 
```js
const {GDLink} = require("alif-media-downloader");
...
## Usage Pintarest 
```js
const {pintarest} = require("alif-media-downloader");
...
## Usage CapCut 
```js
const { capcut } = require("alif-media-downloader");
...
## Usage Likee 
```js
const { likee} = require("alif-media-downloader");
...
## Usage Threads
```js
const { threads } = require("alif-media-downloader");
